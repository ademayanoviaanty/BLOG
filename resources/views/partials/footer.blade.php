<footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, itaque possimus laudantium obcaecati eveniet non at fugit quaerat molestiae optio. Repellat consequatur a error ut non sed quo autem mollitia!</p>
          </div>
          @php
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Ade Maya</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
